...
git clone --depth=1 https://github.com/waelhym/odoo-18-docker-compose $DESTINATION
...
echo "Odoo started at http://localhost:$PORT | Master Password: Admin098765@ | Live chat port: $CHAT"